...
#define SCATTER_NODE 1268985277
#define FRIGHTEN_NODE 1268985277
...
namespace Inky
{
	...
	Direction::Enum OnInkyThink(const Pawn& in_ourPawn, const World& in_ourWorld, float in_deltaTime, float in_totalTime)
	{
		...
		case 0:
			...
			//Use A* for this
			return Greedy(in_ourWorld, in_ourWorld.GetNode(in_ourPawn.GetClosestNode()), in_ourWorld.GetNode(in_ourWorld.GetPacman().GetClosestNode()));
		case 2:
			//Frightened
